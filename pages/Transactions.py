...
def main():
    ...
    account_name = st.selectbox('Account', [account['name'] for account in st.session_state.accounts.values()])
    ...
    if uploaded_file is not None and add_transactions:
        try:
            ...
            df.fillna({'Debit': 0, 'Credit': 0, 'Description1': '', 'Description2': '', 'Description3': ''}, inplace=True)
